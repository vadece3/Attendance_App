...
import com.ns3.Attendance.Attendance;
...
public class ListViewAdapter extends ArrayAdapter<ObjectItem>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        classinfoText.setText("Instructor :"+objectItem.Stream+" Level :"+objectItem.Batch+" Semester :"+objectItem.Semester+" ");
        sectioninfoText.setText("Session :"+objectItem.Section+"  Groups :"+objectItem.Group);
